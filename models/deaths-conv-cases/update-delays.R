...
incubation_period <- get_incubation_period(disease = "SARS-CoV-2", source = "lauer",
                                           max_value = 15)
saveRDS(generation_time , here::here("models", "deaths-conv-cases", "data", "delays", "generation_time.rds"))
saveRDS(incubation_period, here::here("models", "deaths-conv-cases", "data", "delays", "incubation_period.rds"))
...
onset_to_report <- estimate_delay(report_delay$delay_onset_report,
                                  ...
                                  max_value = 15)
saveRDS(onset_to_report, here::here("models", "deaths-conv-cases", "data", "delays", "onset_to_report.rds"))
