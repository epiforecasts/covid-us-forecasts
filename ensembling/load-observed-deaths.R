...
# This is a direct copy of script from Nikos "restructuring" branch (utils/load-observed-deaths.R).
# Adding here temporarily to check functionality while the PR gets sorted
# Diffs: file paths are changed to work with the current master structure: otherwise untouched
...
load_observed_deaths <- function(weekly = FALSE, 
  ...
  true_deaths <- (readRDS(here::here("data", "deaths-data-daily.rds"))) %>%
