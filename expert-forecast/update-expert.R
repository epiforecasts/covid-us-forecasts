...
agg_submission_data <- format_expert_elicitation(for_forecast_date = f_date)

## Visualise results (with and without individual point estimates)
plot_expert(for_forecast_date = f_date, individual = FALSE)
plot_expert(for_forecast_date = f_date, individual = TRUE)
