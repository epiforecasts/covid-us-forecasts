...
source(here::here("timeseries-forecast-daily", "deaths-only", "ts-deaths-only-daily.R"))
source(here::here("timeseries-forecast-daily", "deaths-on-cases", "ts-deaths-on-cases-daily.R"))
...
saveRDS(deaths_only_forecast, here::here("timeseries-forecast-daily", "deaths-only", "raw-samples", "dated", paste0(forecast_date, "-samples-weekly-deaths-only.rds")))
saveRDS(deaths_only_forecast, here::here("timeseries-forecast-daily", "deaths-only", "raw-samples", "latest-samples-weekly-deaths-only.rds"))
...
saveRDS(deaths_on_cases_forecast, here::here("timeseries-forecast-daily", "deaths-on-cases", "raw-samples", "dated", paste0(forecast_date, "-samples-weekly-deaths-on-cases.rds")))
saveRDS(deaths_on_cases_forecast, here::here("timeseries-forecast-daily", "deaths-on-cases", "raw-samples", "latest-samples-weekly-deaths-on-cases.rds"))
