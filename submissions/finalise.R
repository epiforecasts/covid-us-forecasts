...
state_codes <- readRDS("data/state_codes.rds")
# get cumulative data
...
pop_check <- dplyr::left_join(submit_ensemble, readr::read_csv("data/state_pop_totals.csv"), 
...
readr::write_csv(submit_ensemble,
                 here::here("submissions", "submitted",
