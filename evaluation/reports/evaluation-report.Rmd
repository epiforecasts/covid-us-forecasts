...
title: "US forecast Evaluation Report"
...
The following table shows scores averaged across all locations. For state-by-state evaluation of performance of all models, select one of the countries in the drop-down list above.
...
for (variable in names(target_variables)) {
  ...
  for (this_horizon in horizons) {
    ...
    out = c(out, paste("\n\n###", horizon_string, "\n\n"))
    out = c(out, knit_child(here::here("evaluation", "reports",
